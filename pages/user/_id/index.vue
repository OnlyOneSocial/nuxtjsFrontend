              ...
              <span id="FriendsTitle">
                <NuxtLink :to="`/user/${user.id}/friends`" style="text-decoration: unset; color: #000;">{{ $t('FriendsUser') }}</NuxtLink>
                        ...
                        <div class="InputSearch">
                            <img src="/img/search.svg" style="padding: 8px 13px;position:absolute;">
...
export default Vue.extend({
    ...
    methods: {
        ...
        getAvatar (id, avatar) {
            if (avatar) {
                return `https://cdnsocial.katelinlis.xyz/public/clients/${id}/${avatar}`
            } else {
                return 'https://cdnsocial.katelinlis.xyz/public/UserProfileImage.svg'
            }
        },
        ...mapActions({
            getUser: 'UserPage/getUser',
            getPosts: 'UserPage/getPosts'
        })
    }
